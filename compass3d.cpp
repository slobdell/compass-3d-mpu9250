...
void Compass3D::updateFromSensor(float magXOffset, float magYOffset, float magZOffset) {
	...
	// not entirely necessary, but will leave in to follow examples
	ax /= G_SI;
	ay /= G_SI;
	az /= G_SI;
